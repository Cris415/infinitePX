...
Comment.create!({ post_id: post36.id, author_id: jazz.id, comment: "Very nice" })
Comment.create!({ post_id: post37.id, author_id: jazz.id, comment: "Great composition and colors, well done!!" })
Comment.create!({ post_id: post38.id, author_id: jazz.id, comment: "Nice composition" })
Comment.create!({ post_id: post39.id, author_id: jazz.id, comment: "Super great shot" })
...
Comment.create!({ post_id: post49.id, author_id: jazz.id, comment: "Love the colors" })
